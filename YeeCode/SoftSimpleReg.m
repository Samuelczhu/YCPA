...
% Grating
% endPos = 160;
% deltaW = 5;  % Width and spacing
% for i = 1:1:10
%     epi{1}(endPos-deltaW:endPos,10:140)= c_eps_0*11.3;
%     endPos = endPos - deltaW*2;
% end

% % Interesting structure for scattering
epi{1}(120:160,85:135)= c_eps_0*11.3;
epi{1}(120:160,15:65)= c_eps_0*11.3;
...
t0 = 30e-15;
% st = 15e-15;
st = -0.05;  % negative is continuous, positive is Gaussian
s = 0;
y0 = yMax/2;
sty = 1.5*lambda;
...
% Boundary conditions
bc{1}.xm.type = 'a';
bc{1}.xp.type = 'a';  % a for absorb? e for electric wall?
bc{1}.ym.type = 'a';
bc{1}.yp.type = 'a';
